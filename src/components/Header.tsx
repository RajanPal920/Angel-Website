...
const Header: React.FC<HeaderProps> = ({ activePath = "/" }) => {
  ...
  const buildProductItems = (): DropdownItem[] => {
    const products = [
      ...
      { label: "Buttweld Fittings", slug: "buttweld", icon: Icons.ButtWeld },
      { label: "Circles", slug: "circles", icon: Icons.Circles },
      { label: "Coils", slug: "coil", icon: Icons.Coil },
      {
        label: "Dairy Pharma Valves",
        slug: "dairy-pharma-valves",
        icon: Icons.Dairy,
      },
      { label: "Fasteners", slug: "fastener", icon: Icons.Fastener },
      ...
      { label: "Rods", slug: "rod", icon: Icons.Rod },
